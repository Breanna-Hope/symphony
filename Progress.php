				...
				<div class="panel-body">
					<div class="row">
						<table class="table">
							...
							<tbody>
								<?php
								for($i=0; $i < sizeof($prog_note); $i++){
								print_r("<tr><td>");
								if ($prog_note[$i] === NULL){print_r("No Progress Notes Found");} else{ echo $prog_note[$i] ;} 
								print_r("</td><td>");
								if ($prog_date[$i] === NULL){print_r("");} else{ echo $prog_date[$i] ;}
								print_r("</td></tr>");
								}  ?>
							</tbody>
						</table>
