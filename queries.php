...
//sql select statement to retrieve code status.
$sql = "SELECT description FROM vCrgvrPrtl_Medication WHERE mpi_id = '$mpi' AND order_type = 'Advanced Directive'" ;
$stmt= sqlsrv_query( $conn, $sql);
